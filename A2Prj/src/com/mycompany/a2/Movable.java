 ...
 *
 * World bounds are dynamic (set from MapView at runtime) via
 * GameWorld.WORLD_WIDTH/HEIGHT, which are updated in Game after show().
 */
public abstract class Movable extends GameObject {
     ...
     * Bounds come from GameWorld.WORLD_WIDTH/HEIGHT, set after MapView is shown.
     */
